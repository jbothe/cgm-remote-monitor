...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  ['High', 'Elevated', 'Normal', 'Lowish', 'Low'].forEach(function(range) {
    ...
    if (r.rangeRecords.length > 0) {
      ...
      $('<td class="tdborder">' + r.stddev.toFixed(1) + ' (' + Math.round((r.stddev / r.mean) * 100+0.5).toFixed(0) + '%)</td>').appendTo(tr);
      $('<td> </td>').appendTo(tr);
    } else {
...
//    let a1c_mean = Math.round(((ss.mean(mgDlBgs) + 46.7) / 28.7 - 2.15) * 10.929);
//    let a1c_weighted = Math.round(((weighted + 46.7) / 28.7 - 2.15) * 10.929);

//    let a1c_mean = Math.round(((ss.mean(mgDlBgs) + 46.7) / 28.7 - 2.15) * 10.929);
    let a1c_mean = Math.round((ss.mean(mgDlBgs) + 46.7) / 28.7);
    let a1c_weighted = Math.round((weighted + 46.7) / 28.7);
    ...
    $('<td class="tdborder">' + (Math.round(ss.standard_deviation(localBgs) * 10) / 10).toFixed(1) + ' (' + (Math.round(100*(ss.standard_deviation(localBgs)/ss.mean(localBgs))+0.5)).toFixed(0) + '%)</td>').appendTo(tr);
//    $('<td class="tdborder"><center>' + (Math.round(10 * (ss.mean(mgDlBgs) + 46.7) / 28.7) / 10).toFixed(1) + '%<sub>DCCT</sub>&nbsp;|&nbsp;' + Math.round(((ss.mean(mgDlBgs) + 46.7) / 28.7 - 2.15) * 10.929) + '<sub>IFCC</sub>' + (weighted != ss.mean(mgDlBgs) ? ('<br />' + (Math.round(10 * (weighted + 46.7) / 28.7) / 10).toFixed(1) + '%<sub>DCCT</sub>&nbsp;|&nbsp;' + Math.round(((weighted + 46.7) / 28.7 - 2.15) * 10.929) + '<sub>IFCC</sub>') : '') + '</center></td>').appendTo(tr);
//    $('<td class="tdborder"><center>' +
//    	(Math.round(10 * (ss.mean(mgDlBgs) + 46.7) / 28.7) / 10).toFixed(1) + '%<sub>DCCT</sub>&nbsp;|&nbsp;' +
//	a1c_mean + '<sub>IFCC</sub>' + (a1c_mean != a1c_weighted ? ('<br />' +
//	(Math.round(10 * (weighted + 46.7) / 28.7) / 10).toFixed(1) + '%<sub>DCCT</sub>&nbsp;|&nbsp;' +
//	a1c_weighted + '<sub>IFCC</sub>') : '') + '</center></td>').appendTo(tr);
    $('<td class="tdborder"><center>' +
    	(Math.round(10 * a1c_mean) / 10).toFixed(1) + '%<sub>DCCT</sub>&nbsp;|&nbsp;' +
	Math.round((a1c_mean - 2.15) * 10.929) + '<sub>IFCC</sub>' + (a1c_mean != a1c_weighted ? ('<br />' +
	(Math.round(10 * a1c_weighted) / 10).toFixed(1) + '%<sub>DCCT</sub>&nbsp;|&nbsp;' +
	Math.round((a1c_weighted - 2.15) * 10.929) + '<sub>IFCC</sub>') : '') + '</center></td>').appendTo(tr);
  } else {
    $('<td class="tdborder">N/A</td>').appendTo(tr);
    $('<td class="tdborder">N/A</td>').appendTo(tr);
    $('<td class="tdborder">N/A</td>').appendTo(tr);
  ...
  var PGS = Math.round(GVI * glucoseMean * (1 - tirMultiplier) * 10) / 10;
