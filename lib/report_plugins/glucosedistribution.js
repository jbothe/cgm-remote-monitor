...
//    var day =  (latest_time = entry.displayTime.getTime()) / (1000 * 60 * 60 * 24);
//    if (day < 120) {
//      var w = (1 - day/120);
...
//  var weighted = 0;
  ...
  if (glucose_data.length > 0) {
    ...
    $('<td class="tdborder"><center>' + (Math.round(10 * (ss.mean(mgDlBgs) + 46.7) / 28.7) / 10).toFixed(1) + '%<sub>DCCT</sub> | ' + Math.round(((ss.mean(mgDlBgs) + 46.7) / 28.7 - 2.15) * 10.929) + '<sub>IFCC</sub></center><br />').appendTo(tr);
    $('<center>' + (Math.round(10 * (weighted + 46.7) / 28.7) / 10).toFixed(1) + '%<sub>DCCT</sub> | ' + Math.round(((weighted + 46.7) / 28.7 - 2.15) * 10.929) + '<sub>IFCC</sub></center></td>').appendTo(tr);
...
//    table.append(tr);
//    tr = $('<tr><td width="6"> </td>');
//    $('<td class="tdborder"><center>' + (Math.round(10 * (weighted + 46.7) / 28.7) / 10).toFixed(1) + '%<sub>DCCT</sub> | ' + Math.round(((weighted + 46.7) / 28.7 - 2.15) * 10.929) + '<sub>IFCC</sub></center></td>').appendTo(tr);
  } else {
    $('<td class="tdborder">N/A</td>').appendTo(tr);
    $('<td class="tdborder">N/A</td>').appendTo(tr);
    $('<td class="tdborder">N/A</td>').appendTo(tr);
