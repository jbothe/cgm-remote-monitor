...
//    let a1c_mean = Math.round(((ss.mean(mgDlBgs) + 46.7) / 28.7 - 2.15) * 10.929);
    ...
    let a1cwd = (Math.round(10 * weighted) / 10).toFixed(1);
    let a1cwi = Math.round((weighted - 2.15) * 10.929);
...
//    } else {
 ...
 //         '<br />Weighted:&nbsp;' + a1cwd + '%<sub>DCCT</sub>&nbsp;|&nbsp;' + a1cwi + '<sub>IFCC</sub></center></td>').appendTo(tr);
      //$('<td class="tdborder"><center></center></td>').appendTo(tr);
//      $('<td class="tdborder"><center>' + a1cmd + '%<sub>DCCT</sub>&nbsp;|&nbsp;' + a1cmi + '<sub>IFCC</sub></center></td>').appendTo(tr);
      $('<td class="tdborder"><center>' + a1cmd + '%</center></td>').appendTo(tr);
//    }
  } else {
    $('<td class="tdborder">N/A</td>').appendTo(tr);
    $('<td class="tdborder">N/A</td>').appendTo(tr);
